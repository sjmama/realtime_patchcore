    ...
    for dataloader_count, dataloaders in enumerate(dataloader_iter):
        ...
        with device_context:
            ...
            for i, PatchCore in enumerate(PatchCore_list):
                ...
                print(dataloaders["testing"])
                scores, segmentations, labels_gt, masks_gt = PatchCore.predict(###################여기서 프레딕트가 뭐하는건지 알아야됨 여기다 넣어주는거다 데이터로더면 데이터로더로 아니면 이미지로처리
            ...
            print(scores,'3333333333333333333333333333333333333333')
...
def dataset(
    ...
    print('----------------------------')
    print(name, data_path, subdatasets, batch_size, resize, imagesize, num_workers, augment)
